...
This is a sample polling application used for showcase how to use Slack functions, workflows and triggers. For more in depth sample applications you can visit: [Slack samples and templates](https://api.slack.com/automation/samples)
...
$ slack create my-app -t peoplesj/polling-app
